...
ifeq ($(BR2_UCLIBC_BCM63138),y)
UCLIBC_SITE = git://github.com/smx-smx/bcm63138-uclibc.git
UCLIBC_SITE_METHOD = git
UCLIBC_VERSION = v0.9.33.2-bcm
undefine UCLIBC_SOURCE

define UCLIBC_BRCM_INSTALL_DEFCONFIG
	mv $(UCLIBC_BRCM_DEFCONFIG) $(@D)/.config
endef

ifneq ($(UCLIBC_BRCM_DEFCONFIG),)
UCLIBC_PRE_PATCH_HOOKS += UCLIBC_BRCM_INSTALL_DEFCONFIG
endif

else ifeq ($(BR2_UCLIBC_VERSION_SNAPSHOT),y)
...
ifeq ($(BR2_UCLIBC_BCM63138),)
UCLIBC_KCONFIG_FIXUP_CMDS += \
	$(UCLIBC_KCONFIG_COMMON_FIXUP_CMDS) \
